...
import { selectCurrentUser, updateUser } from '../auth/store/authSlice';
...
const ProfilePage: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const userData = {
                ...
                zip_code: profileForm.postal_code,
    ...
    const handleAvatarUpload = async (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            // You would implement actual avatar upload to your backend/cloud storage
            // For now, we'll just create a preview URL and update the form
            ...
            // setProfileForm(prev => ({ ...prev, avatar_url: response.avatar_url }));
    ...
    const handleNotificationUpdate = async () => {
        try {
            // Save notification settings to your backend
    ...
    const handlePrivacyUpdate = async () => {
        try {
            // Save privacy settings to your backend
            const response = await authService.updatePrivacySettings(privacySettings);
            if (response.success) {
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-2 mt-2 text-blue-100">
                                        ...
                                        <span className="text-sm">
                                            Member since {new Date((currentUser as any)?.created_at || Date.now()).toLocaleDateString()}
                                        </span>
                                    </div>
                                </div>
                            </div>
